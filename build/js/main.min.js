...
var _slider = require("./vendor/slider");
...
setTimeout(_text.typeText, 3000);
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // typeText();
  (0, _animation.tlPreview)();
  (0, _video.setupVideo)();
  (0, _initAccordion.initAccordions)();
  (0, _iosVhFix.iosVhFix)();
  (0, _slider.createNewSlider1)();
  (0, _slider.createNewSlider2)();
...
},{"./modules/animation":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/text":14,"./modules/video":15,"./utils/ios-vh-fix":18,"./vendor/init-accordion":21,"./vendor/init-tabs":22,"./vendor/slider":23}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tlPreview = void 0;
var _gsap = require("gsap");
var _ScrollTrigger = require("gsap/dist/ScrollTrigger");
// TextPlugin, EasePack
_gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger);
var tlPreview = function tlPreview() {
  _gsap.gsap.from('#hero-picture', {
    x: 800,
    duration: 3,
    opacity: 0,
    ease: 'back.out(1.5)'
  });
  _gsap.gsap.from('#abonement', {
    x: -800,
    duration: 3,
    opacity: 0,
    ease: 'back.out(1.5)'
  }, '<');
  _gsap.gsap.from('#abonements', {
    x: -800,
    duration: 3,
    opacity: 0,
    scrollTrigger: {
...
var introText = document.querySelector('#city');
// For stable style sheet work, don't write messages longer than 14 characters
var phrases = ['Мoсква', 'Рязань', 'Владимир', 'Новосибирск', 'Тверь', 'Санкт-Петербург', 'Пермь'];
...
function typeText() {
  ...
  var speedUp = Math.random() * (80 - 50) + 50;
  var normalSpeed = Math.random() * (200 - 100) + 100;
  var time1 = deleting ? speedUp : normalSpeed;
  var time = isEnd ? 2000 : time1;
...
},{"./tabs":25}],23:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewSlider2 = exports.createNewSlider1 = void 0;
var _swiper = _interopRequireDefault(require("./swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createNewSlider1 = function createNewSlider1() {
...
exports.createNewSlider1 = createNewSlider1;
var createNewSlider2 = function createNewSlider2() {
  new _swiper.default('.swiper--2', {
    slidesPerView: 1,
    navigation: {
...
exports.createNewSlider2 = createNewSlider2;

},{"./swiper":24}],24:[function(require,module,exports){
